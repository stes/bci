"""
Common Spatial Pattern implementation in Python, used to build spatial filters
for identifying task-related activity.

from https://github.com/spolsley/common-spatial-patterns
"""
import numpy as np
